...
parser.add_argument('--model_tag', type=str, default="XYZ111_Huber", help='tag of the current model')
parser.add_argument('--old_model', type=str, default="XYZ111_Huber", help='name of the pre-trained model')
