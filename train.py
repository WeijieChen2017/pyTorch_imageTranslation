...
parser.add_argument('--model_tag', type=str, default="Huber80", help='tag of the current model')
parser.add_argument('--old_model', type=str, default="Huber80", help='name of the pre-trained model')
