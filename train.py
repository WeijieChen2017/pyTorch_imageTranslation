...
parser.add_argument('--loss_batch_cnt', type=int, default=8, help='loss display batch')
...
parser.add_argument('--model_tag', type=str, default="b128s64d4f8b2", help='tag of the current model')
